...
import { applyMerges, DEFAULT_MERGE_THRESHOLD, findMergeCandidates, formatAlignmentReport, } from './taxonomy-align.js';
function parseArgs(argv) {
    const opts = { threshold: DEFAULT_MERGE_THRESHOLD, apply: false, json: false, show: 30 };
    const num = (raw) => {
        const n = Number(raw);
