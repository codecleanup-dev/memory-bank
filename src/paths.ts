 ...
 */
export const AGENT_HANDSHAKE_MESSAGE = 'Warmup';
 ...
 */
export function isAgentHandshakeExchange(
  userMessage: string | null | undefined,
  isSidechain: boolean | number | null | undefined,
): boolean {
  if (userMessage !== AGENT_HANDSHAKE_MESSAGE) return false;
  return isSidechain === true || isSidechain === 1;
}
